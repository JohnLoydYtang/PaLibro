...
<body>
        ...
        while ($fetch = mysqli_fetch_assoc($result)) {
          echo <<<product
                    <tr class="align-middle">
                        ...
                        <td>
                            <a href="?edit=$fetch[cart_id]" class="btn btn-warning me-2 " style="width: 28%;"><i class="bi bi-pencil-square"></i></a>
  ...
  if (isset($_GET['edit']) && $_GET['edit'] > 0) {
    $query = "SELECT * FROM cart_item WHERE cart_id='$_GET[edit]'";
    $result = mysqli_query($con, $query);
  ...
  <script>
    function confirm_rem(cart_id) {
      if (confirm("Are you sure?")) {
        window.location.href = "crud.php?rem=" + cart_id;
      }
    }
  </script>
