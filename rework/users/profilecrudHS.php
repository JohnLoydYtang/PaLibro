...
if(isset($_GET['rem']) && $_GET['rem']>0)
{
    ...
    if(mysqli_query($con,$query)){
        header("location: user_profileHS.php?success=removed");
    } else {
        header("location: user_profileHS.php?alert=remove_failed");
    }
}
if(isset($_POST['edituser']))
{
    ...
    if(mysqli_query($con,$update)){
        header("location: user_profileHS.php?success=updated");
    } else {
        header("location: user_profileHS.php?alert=update_failed");
    }
}
?>