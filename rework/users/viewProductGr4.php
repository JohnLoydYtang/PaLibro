...
<body>
  ...
  <div class="container mt-4 p-0">
    <table class="table table-hover text-center">
      ...
      <tbody class="bg-white">
        ...
        $query = "SELECT * FROM cart_itemgr4";
        ...
        while ($fetch = mysqli_fetch_assoc($result)) {
          echo <<<product
                    <tr class="align-middle">
                        <th scope="row">$fetch[cart_id]</th>
                        <td>$fetch[title_of_the_book]</td>
                        <td>$fetch[date_of_published]</td>
                        <td>$fetch[author]</td>
                        <td>₱$fetch[price]</td>
                        ...
                        <td>
                            <a href="?edit=$fetch[cart_id]" class="btn btn-warning me-2 "><i class="bi bi-pencil-square"></i></a>
                            <button onclick="confirm_rem($fetch[cart_id])" class="btn btn-danger me-2"><i class="bi bi-trash-fill"></i></button>
                        </td>
                    </tr>
                    product;
        }
  ...
  <div class="modal fade" id="addproduct" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <form action="crudhGr4.php" method="post" enctype="multipart/form-data">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control" placeholder="Title of the book" name="title_of_the_book" required>
            </div>
            <div class="input-group mb-3">
              <span class="input-group-text">Date</span>
              <input type="date" class="form-control" name="date_of_published" required>
            </div>
            <div class="input-group mb-3">
      ...
      <form action="crudhGr4.php" method="post" enctype="multipart/form-data">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="input-group mb-3">
              <span class="input-group-text">Title</span>
              <input type="text" class="form-control" placeholder="Title of the book" name="title_of_the_book" id="edittitle" required>
            </div>
            <div class="input-group mb-3">
              <span class="input-group-text">Date</span>
              <input type="date" class="form-control" name="date_of_published" id="editdate" required>
            </div>
            <div class="input-group mb-3">
              <span class="input-group-text">Author</span>
            ...
            <div class="input-group mb-3">
              <span class="input-group-text">Price</span>
              <input type="number" class="form-control" placeholder="Price" name="price" id="editprice" required>
            </div>
            <div class="input-group mb-3">
              <span class="input-group-text">ELEMENTARY</span>
              <select name="grade_level" class="form-control" id="editgrade" required>
                <option value="grade4">grade 4</option>
              </select>
            </div>
  ...
  if (isset($_GET['edit']) && $_GET['edit'] > 0) {
    $query = "SELECT * FROM cart_itemgr4 WHERE cart_id='$_GET[edit]'";
    $result = mysqli_query($con, $query);
    ...
    echo "
      ...
      document.querySelector('#edittitle').value=`$fetch[title_of_the_book]`;
      document.querySelector('#editdate').value=`$fetch[date_of_published]`;
      document.querySelector('#editauthor').value=`$fetch[author]`;
      document.querySelector('#editprice').value=`$fetch[price]`; 
      document.querySelector('#editgrade').value=`$fetch[grade_level]`;
  ...
  <script>
    function confirm_rem(cart_id) {
      if (confirm("Are you sure?")) {
        window.location.href = "crudhGr4.php?rem=" + cart_id;
      }
    }
  </script>
