...
<body>
    ...
    <table class="table table-hover text-center">
      ...
      <tbody class="bg-white">
        ...
        if (isset($_POST['search'])) {
          ...
          $query = "SELECT * FROM checkout_item WHERE Reference_No LIKE '%$search_ref_no%'";
        } else {
  ...
  <div class="modal fade" id="editorder" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <form action="ordercrud.php" method="post" enctype="multipart/form-data">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control" name="title_of_the_book" id="edittitle_of_the_book" required>
            </div>
            <div class="input-group mb-3">
            ...
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control" placeholder=" " name="grade_level" id="editgrade_level" required>
            </div>
            <div class="input-group mb-3">
  ...
  if (isset($_GET['edit']) && $_GET['edit'] > 0) {
    $query = "SELECT * FROM checkout_item WHERE Reference_No='$_GET[edit]'";
    $result = mysqli_query($con, $query);
    ...
    echo "
      ...
      document.querySelector('#edittitle_of_the_book').value=`$fetch[title_of_the_book]`;
      document.querySelector('#editdates_of_purchase').value=`$fetch[dates_of_purchase]`;
      document.querySelector('#editgrade_level').value=`$fetch[grade_level]`; 
  ...
  <script>
    function confirm_rem(cart_id) {
      if (confirm("Are you sure?")) {
        window.location.href = "ordercrud.php?rem=" + cart_id;
      }
    }
  </script>
</body>
