...
<body>
  ...
  <div class="container mt-4 p-0">
    <table class="table table-hover text-center">
      ...
      <tbody class="bg-white">
        ...
        $query = "SELECT * FROM cart_itemgr2";
  ...
  <div class="modal fade" id="addproduct" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <form action="crudGr2.php" method="post" enctype="multipart/form-data">
  ...
  if (isset($_GET['edit']) && $_GET['edit'] > 0) {
    $query = "SELECT * FROM cart_itemgr2 WHERE cart_id='$_GET[edit]'";
    $result = mysqli_query($con, $query);
  ...
  <script>
    function confirm_rem(cart_id) {
      if (confirm("Are you sure?")) {
        window.location.href = "crudGr2.php?rem=" + cart_id;
      }
    }
  </script>
