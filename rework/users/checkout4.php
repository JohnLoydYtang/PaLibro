...
require_once('php/createDbgr4.php');
require_once('php/componentg4.php');

$db = new CreateDb(dbname: "user_db", tablename: "cart_itemgr4");
	...
	if ($_GET['action'] == 'remove') {
		foreach ($_SESSION['cart'] as $key => $value) {
			if ($value["cart_id"] == $_GET['cart_id']) {
				...
				echo "<script>window.location='checkout4.php'</script>";
			}
		}
	}
}
...
<body class="bg-light">
	<?php
	require_once('php/headergr4.php');
	?>
