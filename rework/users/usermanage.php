<?php
session_start();
require_once("userprofileconfig.php");
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <tbody class="bg-white">
                ...
                while ($fetch = mysqli_fetch_assoc($result)) {
                    ...
                    <tr class="align-middle">
                        ...
                        <td>
                            <a href="?edit=$fetch[id]" class="btn btn-success me-2 ">View Details</a>
                            <button onclick="confirm_rem($fetch[id])" class="btn btn-danger me-2"><i class="bi bi-trash-fill"></i></button>
                        </td>
                    </tr>
                    product;
                }
...
if (isset($_GET['edit']) && $_GET['edit'] > 0) {
    ...
    // Use FETCH_SRC to get the image URL
    $image_src = FETCH_SRC . $fetch['images'];
    ...
    echo "
      ...
      document.querySelector('#editimg').src = " . json_encode($image_src) . ";
    ...
    <script>
        function confirm_rem(cart_id) {
            if (confirm("Are you sure?")) {
                window.location.href = "usercrud.php?rem=" + cart_id;
            }
        }
    </script>
</body>
