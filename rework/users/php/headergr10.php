<header id="header">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a href="cart10.php" class="navbar-brand">
            <h3 class="px-5">
                <i class="fas fa-shopping-basket" style="padding-left: 30%;"></i> GRADE 10
            </h3>
        </a>
        <!-- menu button -->
        <div class="menu-btn">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup"> -->
            <div class="mr-auto">
                <div class="navbar-nav" style="position: absolute; right: 0; top: 19%;">
                    <a href="checkout10.php" class="nav-item nav-link active">
                        <h5 class="px-5 cart">
