...
require_once('php/createDbgr5.php');
require_once('php/componentg5.php');

$db = new CreateDb(dbname: "user_db", tablename: "cart_itemgr5");
	...
	if ($_GET['action'] == 'remove') {
		foreach ($_SESSION['cart'] as $key => $value) {
			if ($value["cart_id"] == $_GET['cart_id']) {
				...
				echo "<script>window.location='checkout5.php'</script>";
			}
		}
	}
}
...
<body class="bg-light">
	<?php
	require_once('php/headergr5.php');
	?>
